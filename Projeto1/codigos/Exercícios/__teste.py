...
if (s*30)/100 >= v /(a*12)*70/100:
    ...
    sleep(1)
    print(emoji.emojize(':rage: {} Muito bem, vai ter facilidade em pagar...{}'.format(cores['azul'], cores['limpa']), use_aliases=True))
    print(' ')
    sleep(1)
elif (s*30)/100 >= v /(a*12)*30/100 and (s*30)/100 < v /(a*12)*50/100:
    sleep(1)
...
if e > p:
    ...
    print('{}ÓTIMO! Em breve te enviaremos toda a documentação por e-mail para finalizar o processo{}'.format(cores['verde'], cores['limpa']))
    print('{}A FINANCIA agradesce a preferencia{}'.format(cores['verde'], cores['limpa']))
